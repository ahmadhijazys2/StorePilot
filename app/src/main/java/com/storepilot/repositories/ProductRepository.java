...
public class ProductRepository {
    ...
    public LiveData<Product> getById(int id) { return productDao.getById(id); }
    public LiveData<List<Product>> getLowStockProducts(int threshold) { return productDao.getLowStockProducts(threshold); }
    public LiveData<List<Product>> getTopSellingProducts(long startDate, long endDate) { return productDao.getTopSellingProducts(startDate, endDate); }
