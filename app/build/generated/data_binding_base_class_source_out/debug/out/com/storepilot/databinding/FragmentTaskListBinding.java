...
public final class FragmentTaskListBinding implements ViewBinding {
  ...
  @NonNull
  public final TabLayout tabLayoutTasks;
  ...
  private FragmentTaskListBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull TabLayout tabLayoutTasks) {
    this.rootView = rootView;
    this.fabAddTask = fabAddTask;
    this.recyclerTasks = recyclerTasks;
    this.tabLayoutTasks = tabLayoutTasks;
  }
  ...
  public static FragmentTaskListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tabLayoutTasks;
      TabLayout tabLayoutTasks = ViewBindings.findChildViewById(rootView, id);
      if (tabLayoutTasks == null) {
        break missingId;
      }

      return new FragmentTaskListBinding((LinearLayout) rootView, fabAddTask, recyclerTasks,
          tabLayoutTasks);
    }
